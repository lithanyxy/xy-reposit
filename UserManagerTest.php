...
class UserManagerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testGetUserByEmailPassword()
    {
       ...
       // $this->userManager->getUserByEmailPassword("sendxinyi@gmail.com","Password01");
	    $user = $this->userManager->getUserByEmailPassword("sendxinyi@gmail.com","Password01");
    ...
    public function testGetUserById()
    {
		...
		$user = $this->userManager->getUserById(3);
		$this->assertInstanceof('\classes\entity\user', $user);
    }
