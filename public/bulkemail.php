...
<form name="myForm" method="post" class="pure-form pure-form-stacked" action="bulkemailproc.php">
<table border='0' width="100%">
  <tr>    
    <td>Emails</td>
    <td><input type="email" name="emails" value="<?=$email?>" pattern=".{1,}"   required title="Cannot be empty field" size="30"></td>
